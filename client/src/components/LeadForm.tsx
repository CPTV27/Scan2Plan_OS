...
export function LeadForm({ lead, onSuccess, onOpenCPQ, onOpenResearch, onOpenCommunication, onDelete, isDeleting }: LeadFormProps) {
  ...
  const form = useForm<FormData>({
    ...
    defaultValues: lead ? {
      ...
      projectName: "Test Project - Office Renovation",
      projectAddress: "123 Main Street, Philadelphia, PA 19103",
      value: 25000,
      dealStage: "Leads",
      probability: 50,
      notes: "Test lead for development purposes",
      quoteNumber: "",
      buildingType: "2",
      sqft: 15000,
      scope: "full",
      ...
      leadSource: "Website",
      source: "referral",
      referrerCompanyName: "Partner Architecture Firm",
      referrerContactName: "John Referrer",
      leadPriority: 3,
      cpqAreas: [],
      cpqRisks: [],
      cpqTravel: { dispatchLocation: "brooklyn", miles: 45 },
      cpqServices: {},
      cpqScopingData: {},
    },
  });
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <Select onValueChange={field.onChange} defaultValue={field.value || "cold_outreach"}>
                        <FormControl>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <Select onValueChange={(val) => field.onChange(parseInt(val))} defaultValue={String(field.value || 3)}>
                        <FormControl>
